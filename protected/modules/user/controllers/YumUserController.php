...
class YumUserController extends YumController {
	...
	public function actionCreate() {
		...
		// insert an _active_ user
                // PAVLO CHUMACHENKO: This code will not work. We get status from $_POST array
		...
		if(isset($_POST['YumUser'])) {
			...
			$model->activationKey = YumEncrypt::encrypt(microtime() . $model->password, $model->salt);			
				...
				$model->username = $this->getNewUsername($profile->email);
...
//                            }
        ...
        public function getNewUsername($email)
        {
